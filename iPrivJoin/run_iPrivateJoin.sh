# nohup bash run_iPrivateJoin.sh > run_iPrivateJoin.log 2>&1 &
...
# ./build/iPrivJoin  configIO_CFI 0 /root/zqz/mpc_projects/data/CFIY1024.json  &
# ./build/iPrivJoin  configIO_CFI 1 /root/zqz/mpc_projects/data/CFIX_1row.json 
...
./build/iPrivJoin  configIO_SVHN 0 /root/zqz/mpc_projects/data/SVHNY1024.json  &
./build/iPrivJoin  configIO_SVHN 1 /root/zqz/mpc_projects/data/SVHNX_1row.json 
